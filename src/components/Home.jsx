        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Copy className="group-hover:text-sucess-500 text-gray-200" size={20} />
              </button>
            </div>
          </div>
          ...
          <textarea
            ...
            className="w-full p-3 bg-gray-800 text-white focus-visible:ring-0 resize-none outline-none"
            style={{
              caretColor: "#000",
            }}
            rows={20}
